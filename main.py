    ...
    <head>
        ...
        <style>
            :root {
                ...
                --gold-primary: #f3c68f;
                --gold-glow: #d4af37;
                --card-glass: rgba(10, 26, 18, 0.85);
                --border-glass: rgba(243, 198, 143, 0.25);
                --text-main: #f4f9f5;
                --text-muted: #95b8a6;
            }
            body { 
                ...
                margin: 0; padding: 50px 15px 35px 15px; text-align: center; color: var(--text-main); 
                display: flex; flex-direction: column; min-height: 80vh; justify-content: space-between; background-attachment: fixed;
            }
            .wrapper { max-width: 540px; margin: 30px auto 0 auto; width: 100%; position: relative; }
            .logo-container {
                position: absolute;
                top: -55px;
                left: 50%;
            ...
            .logo-img { 
                ...
                box-shadow: 0 10px 30px rgba(0,0,0,0.7), 0 0 20px rgba(212, 175, 55, 0.4); 
                object-fit: cover;
                background: #0f2a1d;
            }
            .container { 
                background: var(--card-glass); padding: 75px 28px 45px 28px; border-radius: 28px; 
                box-shadow: 0 30px 70px rgba(0, 0, 0, 0.6), 0 0 50px rgba(27, 67, 50, 0.3); 
                border: 1px solid var(--border-glass); text-align: right; backdrop-filter: blur(25px); position: relative;
            }
            .container::before {
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="container">
                ...
                <a href="/module_manage?name=محاضرات قواعد تفسير النصوص" class="btn btn-secondary">قواعد تفسير النصوص</a>
                <a href="/module_manage?name=محاضرات قضايا فقهية معاصرة" class="btn btn-secondary">قضايا فقهية معاصرة</a>
                <a href="/module_manage?name=محاضرات المواريث" class="btn btn-secondary">المواريث</a>
                <a href="/module_manage?name=محاضرات مقاصد الشريعة" class="btn btn-secondary">مقاصد الشريعة</a>
                <a href="/module_manage?name=محاضرات النظام القضائي" class="btn btn-secondary">محاضرات النظام القضائي</a>
                <a href="/module_manage?name=محاضرات التفسير و الحديث الموضوعي" class="btn btn-secondary">التفسير و الحديث الموضوعي</a>
                <a href="/module_manage?name=محاضرات الحوكمة و أخلاقيات المهنة" class="btn btn-secondary">الحوكمة و أخلاقيات المهنة</a>
            </div>
        </div>
        <footer>جميع الحقوق محفوظة منصة كلية الشريعة ©2026</footer>
    </body>
...
# 3. صفحة إدارة محتوى المقياس ورفع الملفات
